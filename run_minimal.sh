...
# Script minimalista para ejecutar la aplicación TRM Colombia
# Esta versión usa un archivo Python extremadamente simplificado
...
print_message "Instalando dependencias mínimas..."
pip install pandas matplotlib streamlit

# Verificar si el archivo simple_trm.py existe
if [ ! -f "$PYTHON_APP_DIR/simple_trm.py" ]; then
    print_error "El archivo simple_trm.py no existe en $PYTHON_APP_DIR"
    exit 1
fi
